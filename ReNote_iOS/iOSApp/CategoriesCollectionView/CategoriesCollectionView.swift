...
class CategoriesCollectionView: UICollectionView {
    ...
    var selectedCategories = [NoteCategory]()
    ...
    func setCategories(_ categories: [NoteCategory]) {
        var newcategories = categories
        
        if withAllCategory {
            newcategories.insert(NoteCategory(id: -1, name: "All"), at: 0)
        }
    ...
    func addCategory(_ category: NoteCategory, needsToBeSelected: Bool = false) {
